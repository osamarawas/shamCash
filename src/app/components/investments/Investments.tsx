...
const Investments = () => {
  return (
    <div className='h-full py-10 dark:background-terms-dark background-terms-light'>
      ...
      <p dir='rtl' className='mx-auto text-center text-lg font-semibold max-w-lg'>أهلاً ومرحباً بك في خدمة شام كاش، نحن فخورون بأن نقدم لك خدمة الدفع الإلكتروني, من خلال استخدامك لهذا البرنامج، فإنك توافق على الالتزام بالشروط والأحكام التالية:</p>
      <InvestmentsCard term={terms} />
      <div dir='rtl' className='flex border-solid border-2 border-red-700 rounded-lg p-6 w-3/4 mx-auto mt-14'>
